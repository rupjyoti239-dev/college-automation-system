  ...
  <section class="bg-primary-subtle">
    <div class="d-flex justify-content-evenly align-items-center py-3">
      ...
      <div class="text-center">
        ...
        <p class="text-black">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Totam nihil hic necessitatibus
          perferendis <br>
          temporibus placeat magnam! Pariatur laborum eaque non.</p>
      </div>
      <img src="../images/side-logo.webp" class="rounded-circle" alt="" width="150px">
    </div>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item mx-4">
              <a class="nav-link fw-medium text-white" href="../index.php">ABOUT US</a>
            </li>
            <li class="nav-item mx-4">
              <a class="nav-link fw-medium text-white" href="#">COURSES</a>
              <ul class="course__submenu">
                <li><a class="nav-link fw-medium text-black link-primary" href="./bca.php">BCA</a></li>
                <li><a class="nav-link fw-medium text-black link-primary" href="./mca.php">MCA</a></li>
                <li><a class="nav-link fw-medium text-black link-primary" href="./bba.php">BBA</a></li>
                <li><a class="nav-link fw-medium text-black link-primary" href="./mba.php">MBA</a></li>
                <li><a class="nav-link fw-medium text-black link-primary" href="./bcom.php">B.Com</a></li>
                <li><a class="nav-link fw-medium text-black link-primary" href="./mcom.php">M.com</a></li>
              </ul>
            </li>
            <li class="nav-item mx-4">
